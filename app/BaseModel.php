...
//    }
    ...
    public function translation(){
        return $this->hasOne($this->getTranslationModelNameDefault(),'origin_id')->where('locale',request()->query('lang',app()->getLocale()));
    }
    ...
    public function getNewTranslation($locale){
        ...
        $translation = app()->make($modelName);
        $translation->locale = $locale;
        $translation->origin_id = $this->getKey();
